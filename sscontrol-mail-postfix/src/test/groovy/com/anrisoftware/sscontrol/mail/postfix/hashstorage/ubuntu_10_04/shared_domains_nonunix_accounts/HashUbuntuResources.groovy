...
enum HashUbuntuResources {
	...
	mailboxMapsNonUnixExpected("/etc/postfix/mailbox_maps", HashUbuntuResources.class.getResource("mailbox_maps_nonunix_expected.txt")),
	mailboxMapsExpected("/etc/postfix/mailbox_maps", HashUbuntuResources.class.getResource("mailbox_maps_expected.txt")),
	aliasMapsNonUnixExpected("/etc/postfix/alias_maps", HashUbuntuResources.class.getResource("alias_maps_nonunix_expected.txt")),
