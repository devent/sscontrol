...
import com.anrisoftware.sscontrol.httpd.yourls.fromarchive.YourlsFromArchiveConfig

/**
 * <i>Ubuntu 12.04 Yourls</i> from an archive configuration.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
class UbuntuYourlsFromArchive extends YourlsFromArchiveConfig {

    @Inject
    YourlsArchivePropertiesProvider propertiesProvider

    @Override
    ContextProperties getYourlsFromArchiveProperties() {
