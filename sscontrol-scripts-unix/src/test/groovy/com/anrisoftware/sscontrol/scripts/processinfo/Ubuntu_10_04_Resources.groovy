...
enum Ubuntu_10_04_Resources {
    ...
    psCommand("/bin/ps", Ubuntu_10_04_Resources.class.getResource("ps_command.txt")),
    psOutExpected("/bin/ps.out", Ubuntu_10_04_Resources.class.getResource("ps_out_expected.txt")),
