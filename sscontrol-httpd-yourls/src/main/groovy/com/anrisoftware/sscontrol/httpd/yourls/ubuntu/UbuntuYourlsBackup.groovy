...
/**
 * <i>Ubuntu Yourls</i> backup.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
abstract class UbuntuYourlsBackup {
     ...
     */
    void backupService(Domain domain, YourlsService service) {
        if (service.backupTarget != null) {
            File source = yourlsDir domain, service
     ...
     */
    abstract UbuntuYourlsArchiveServiceBackup getServiceBackup()

    /**
     * Returns the <i>MySQL</i> database backup.
     */
    abstract UbuntuYourlsMysqlDatabaseBackup getMysqlDatabaseBackup()
