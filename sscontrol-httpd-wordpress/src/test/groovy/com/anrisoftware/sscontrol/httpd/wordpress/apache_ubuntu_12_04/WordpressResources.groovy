...
enum WordpressResources {
    ...
    nooverrideWordpressConfigSample("/var/www/www.test1.com/myprefix/wp-config-sample.php", WordpressResources.class.getResource("wordpress_config_sample_php.txt")),
    nooverrideWordpressConfig("/var/www/www.test1.com/myprefix/wp-config.php", WordpressResources.class.getResource("wordpress_config_sample_php.txt")),
