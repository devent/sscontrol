...
/**
 * <i>FrontAccounting 2.3</i> web service factory.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(WebServiceFactoryFactory.class)
public class Frontaccounting_2_3_FactoryFactory implements WebServiceFactoryFactory {

    /**
     * <i>FrontAccounting 2.3</i> service name.
     */
    public static final String SERVICE_NAME = "frontaccounting_2_3";
    ...
    private static final Module[] MODULES = new Module[] { new Frontaccounting_2_3_Module() };

    private Injector injector;

    public Frontaccounting_2_3_FactoryFactory() {
    }

    @Override
    public WebServiceFactory getFactory() throws ServiceException {
        return injector.getInstance(Frontaccounting_2_3_ServiceFactory.class);
    }
