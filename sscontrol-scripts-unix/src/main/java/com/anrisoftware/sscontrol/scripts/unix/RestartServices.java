 ...
 * @since 1.0
 */
public class RestartServices extends AbstractProcessExec {
    ...
    private final RestartServicesLogger log;
     ...
     */
    @Inject
    RestartServices(RestartServicesLogger log, @Assisted Object parent,
    ...
    protected CommandLine createLine(ScriptCommandLineFactory commandLineFactory) {
        ...
        String name = format("%s%s", "restart", capitalize(system));
    ...
    public ProcessTask call() throws Exception {
        ...
        log.restartedDone(parent, runCommands, task, args);
        return task;
    }
