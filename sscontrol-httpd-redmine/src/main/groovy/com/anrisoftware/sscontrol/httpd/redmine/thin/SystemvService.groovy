...
abstract class SystemvService {
     ...
     */
    void createService(Domain domain, RedmineService service) {
     ...
     *            the {@link GititService}.
     */
    void activateService(Domain domain, RedmineService service) {
     ...
     *            the {@link GititService}.
     */
    void restartService(Domain domain, RedmineService service) {
