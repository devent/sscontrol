...
public interface StopServicesFactory {
     ...
     *
     *            <li>{@code command} the stop service {@link String} command;
     *
     *            <li>{@code services} the {@link List} the services to stop;
     *
     ...
     */
    StopServices create(Map<String, Object> args, Object parent, Threads threads);
}
