...
class UfwModule extends AbstractModule {
	...
	private static final URL UFW_LINUX_DEFAULT_PROPERTIES_URL = UfwModule.class
			.getResource("/ufw_linux_default.properties");
	...
	ContextProperties getMaradnsLinuxDefaultProperties() throws IOException {
		return new ContextPropertiesFactory(LinuxScript.class)
				.fromResource(UFW_LINUX_DEFAULT_PROPERTIES_URL);
	}
}
