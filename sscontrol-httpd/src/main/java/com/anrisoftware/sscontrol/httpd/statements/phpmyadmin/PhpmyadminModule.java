...
import static com.anrisoftware.sscontrol.httpd.statements.phpmyadmin.PhpmyadminService.NAME;
...
/**
 * Installs the phpmyadmin service factory.
 * 
...
public class PhpmyadminModule extends AbstractModule {
	...
	protected void configure() {
		install(new FactoryModuleBuilder().implement(WebService.class,
				PhpmyadminService.class).build(PhpmyadminServiceFactory.class));
		bindService();
	}
