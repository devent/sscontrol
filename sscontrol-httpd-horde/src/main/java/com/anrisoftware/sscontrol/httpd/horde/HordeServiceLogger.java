...
import static com.anrisoftware.sscontrol.httpd.gitit.HordeServiceLogger._.debug_set_debug;
import static com.anrisoftware.sscontrol.httpd.gitit.HordeServiceLogger._.debug_set_info;
import static com.anrisoftware.sscontrol.httpd.gitit.HordeServiceLogger._.override_mode_null;
import static com.anrisoftware.sscontrol.httpd.gitit.HordeServiceLogger._.override_mode_set_debug;
import static com.anrisoftware.sscontrol.httpd.gitit.HordeServiceLogger._.override_mode_set_info;
...
/**
 * Logging messages for {@link HordeService}.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@Singleton
class HordeServiceLogger extends AbstractLogger {
    ...
    /**
     * Creates a logger for {@link HordeService}.
     */
    public HordeServiceLogger() {
        super(HordeService.class);
    }
    ...
    void overrideModeSet(HordeService service, OverrideMode mode) {
        if (isDebugEnabled()) {
