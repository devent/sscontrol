...
/**
 * Provides the proxy pass <i>Ubuntu 12.04</i> properties from
 * {@code "/nginx_proxypass_ubuntu_12_04.properties"}.
 * 
...
class UbuntuPropertiesProvider extends AbstractContextPropertiesProvider {
    ...
    private static final URL RESOURCE = UbuntuPropertiesProvider.class
            .getResource("/nginx_proxypass_ubuntu_12_04.properties");
