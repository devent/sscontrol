...
import static com.anrisoftware.sscontrol.httpd.redmine.ubuntu_12_04_nginx_thin_redmine_2_6_patchpiwik.RedmineResources.*
...
/**
 * <i>Ubuntu 12.04</i> patch <i>Piwik</i> test.
 *
...
class RedmineTest extends WebServiceTestEnvironment {
    ...
    void "redmine, patch piwik"() {
        ...
        assertFileContent basehtmlerbExpected.asFile(tmpdir), basehtmlerbExpected
    }
}
