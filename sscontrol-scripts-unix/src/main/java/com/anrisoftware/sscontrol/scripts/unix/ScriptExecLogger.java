...
class ScriptExecLogger extends AbstractLogger {
    ...
    enum _ {
        ...
        script_done_trace("Installed packages {} for {}, {}."),

        script_done_debug("Installed packages {} for {}."),

        script_done_info("Installed service packages for script {}.");
    ...
    void checkArgs(ScriptExec exec, Map<String, Object> args) {
