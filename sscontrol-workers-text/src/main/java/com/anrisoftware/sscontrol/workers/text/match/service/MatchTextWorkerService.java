 ...
 */
package com.anrisoftware.sscontrol.workers.text.match.service;
...
/**
 * Provides the worker that match text as a service.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(WorkerService.class)
public class MatchTextWorkerService implements WorkerService {

	public static final String NAME = "match_text_worker";

	private final LazyInjector lazyInjector;

	public MatchTextWorkerService() {
