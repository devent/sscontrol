...
/**
 * <i>Citadel Nginx Ubuntu 14.04</i> configuration factory.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Citadel_Nginx_Ubuntu_14_04_ConfigFactory implements ServiceConfigFactory {

    /**
     * <i>Ubuntu 14.04</i> profile name.
     */
     ...
     */
    public static final String WEB_NAME = "citadel";
    ...
    private static final Module[] MODULES = new Module[] { new Nginx_Ubuntu_14_04_Module() };

    private Injector injector;

    public Citadel_Nginx_Ubuntu_14_04_ConfigFactory() {
    }

    @Override
    public ServiceConfig getScript() throws ServiceException {
        return injector.getInstance(Citadel_Nginx_Ubuntu_14_04_Config.class);
    }
