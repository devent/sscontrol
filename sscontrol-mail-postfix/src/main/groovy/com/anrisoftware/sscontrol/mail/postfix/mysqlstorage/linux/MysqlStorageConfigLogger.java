...
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.alias_table;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.alias_table1;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.alias_table2;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_aliases;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_aliases2;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_domains;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_domains2;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_users;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.deployed_users2;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.domains_table;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.domains_table1;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.domains_table2;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.rehash_file;
...
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.users_table;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.users_table1;
import static com.anrisoftware.sscontrol.mail.postfix.mysqlstorage.linux.MysqlStorageConfigLogger._.users_table2;
...
class MysqlStorageConfigLogger extends AbstractLogger {
	...
	void deployedDomainsTable(MysqlStorageConfig script,
	...
	void deployedAliasesTable(MysqlStorageConfig script,
			ScriptCommandWorker worker) {
		if (isTraceEnabled()) {
	...
	void deployedUsersTable(MysqlStorageConfig script,
			ScriptCommandWorker worker) {
		if (isTraceEnabled()) {
	...
	void deployedDomainsData(MysqlStorageConfig script,
			ScriptCommandWorker worker) {
		if (isDebugEnabled()) {
	...
	void resetDomainsData(MysqlStorageConfig script, ScriptCommandWorker worker) {
		if (isTraceEnabled()) {
	...
	void deployedAliasesData(MysqlStorageConfig script,
			ScriptCommandWorker worker) {
		if (isDebugEnabled()) {
	...
	void resetAliasesData(MysqlStorageConfig script, ScriptCommandWorker worker) {
		if (isTraceEnabled()) {
	...
	void deployedUsersData(MysqlStorageConfig script, ScriptCommandWorker worker) {
		if (isDebugEnabled()) {
	...
	void resetUsersData(MysqlStorageConfig script, ScriptCommandWorker worker) {
		if (isTraceEnabled()) {
	...
	void rehashFileDone(MysqlStorageConfig script, Object file,
			ScriptCommandWorker worker) {
		if (isDebugEnabled()) {
