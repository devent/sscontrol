...
/**
 * <i>Ubuntu 12.04 Piwik</i> from an archive configuration.
 *
...
class UbuntuPiwikFromArchive extends PiwikFromArchive {
    ...
    @Inject
    PiwikArchivePropertiesProvider piwikArchivePropertiesProvider

    @Override
    ContextProperties getPiwikArchiveProperties() {
        piwikArchivePropertiesProvider.get()
    }
}
