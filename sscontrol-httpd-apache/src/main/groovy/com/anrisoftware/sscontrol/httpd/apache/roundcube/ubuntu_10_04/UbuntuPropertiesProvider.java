...
/**
 * Provides the default Roundcube Ubuntu 10.04 properties from
 * {@code "/apache_roundcube_ubuntu_10_04.properties"}.
 * 
...
class UbuntuPropertiesProvider extends AbstractContextPropertiesProvider {
    ...
    private static final URL RESOURCE = UbuntuPropertiesProvider.class
            .getResource("/apache_roundcube_ubuntu_10_04.properties");
