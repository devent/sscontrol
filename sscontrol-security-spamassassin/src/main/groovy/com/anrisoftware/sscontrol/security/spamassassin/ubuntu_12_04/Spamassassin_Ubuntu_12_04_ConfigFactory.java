...
/**
 * <i>Spamassassin Ubuntu 12.04</i> configuration factory.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Spamassassin_Ubuntu_12_04_ConfigFactory implements
    ...
    public Spamassassin_Ubuntu_12_04_ConfigFactory() {
    }

    @Override
    public ServiceConfig getScript() throws ServiceException {
        return injector.getInstance(Ubuntu_12_04_Config.class);
    }
