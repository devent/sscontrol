...
/**
 * Provides the proxy pass <i>Ubuntu 14.04</i> properties from
 * {@code "/nginx_proxypass_ubuntu_14_04.properties"}.
 *
...
class UbuntuPropertiesProvider extends AbstractContextPropertiesProvider {
    ...
    private static final URL RESOURCE = UbuntuPropertiesProvider.class
            .getResource("/nginx_proxypass_ubuntu_14_04.properties");
