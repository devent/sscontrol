...
import com.anrisoftware.sscontrol.httpd.frontaccounting.fromarchive.FrontaccountingFromArchiveConfig

/**
 * <i>Ubuntu 12.04 FrontAccounting</i> from an archive configuration.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
class Ubuntu_12_04_FrontaccountingFromArchive extends FrontaccountingFromArchiveConfig {

    @Inject
    FrontaccountingArchivePropertiesProvider propertiesProvider

    @Override
    ContextProperties getFrontaccountingFromArchiveProperties() {
