...
/**
 * <i>FUDForum Apache php-fcgi</i> configuration.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
abstract class ApacheFcgiFudforumConfig extends FcgiFudforumConfig {

    @Inject
    private ApacheFcgiFudforumConfigLogger log
     ...
     */
    void createDomainConfig(Domain domain, Domain refDomain, FudforumService service, List config) {
     ...
     *            the {@link FudforumService} service.
     *
     * @see #wordpressDir(Domain, FudforumService)
     */
