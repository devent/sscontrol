...
enum Ubuntu_12_04_Resources {
    ...
    ufwSshConfExpected("/etc/fail2ban/action.d/ufw-ssh.conf", Ubuntu_12_04_Resources.class.getResource("ufw_ssh_conf_expected.txt")),
    ufwSshddosConfExpected("/etc/fail2ban/action.d/ufw-ssh-ddos.conf", Ubuntu_12_04_Resources.class.getResource("ufw_ssh_ddos_conf_expected.txt")),
    jailConfExpected("/etc/fail2ban/jail.local", Ubuntu_12_04_Resources.class.getResource("jail_local_expected.txt")),
    ufwCommand("/usr/sbin/ufw", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
    ufwOutExpected("/usr/sbin/ufw.out", Ubuntu_12_04_Resources.class.getResource("ufw_out.txt")),
    rsyslogConfigFile("/etc/rsyslog.conf", Ubuntu_12_04_Resources.class.getResource("rsyslog_conf.txt")),
    rsyslogConfigExpected("/etc/rsyslog.conf", Ubuntu_12_04_Resources.class.getResource("rsyslog_conf_expected.txt")),
    rsyslogRestartCommand("/sbin/restart", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
