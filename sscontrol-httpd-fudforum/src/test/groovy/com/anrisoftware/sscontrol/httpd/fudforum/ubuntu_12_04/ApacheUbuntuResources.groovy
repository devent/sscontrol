 ...
 */
package com.anrisoftware.sscontrol.httpd.fudforum.ubuntu_12_04
...
enum ApacheUbuntuResources {
    ...
    netstatCommand("/bin/netstat", ApacheUbuntuResources.class.getResource("echo_command.txt")),
    mysqlCommand("/usr/bin/mysql", ApacheUbuntuResources.class.getResource("echo_command.txt")),
