 ...
 * @since 1.0
 */
enum LdapCoreResources {

    ldapScript("Ldap.groovy", LdapCoreResources.class.getResource("Ldap.groovy")),
    ldapaddOut("/usr/bin/ldapadd.out", LdapCoreResources.class.getResource("ldapadd_out.txt")),
    ldapmodifyOut("/usr/bin/ldapmodify.out", LdapCoreResources.class.getResource("ldapmodify_out.txt")),
    dbConf("/etc/ldap/db.ldif", LdapCoreResources.class.getResource("db_ldif.txt")),
    baseConf("/etc/ldap/base.ldif", LdapCoreResources.class.getResource("base_ldif.txt")),
    ...
    LdapCoreResources(String path, URL resource) {
