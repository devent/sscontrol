...
/**
 * <i>Ubuntu 12.04 Apache FrontAccounting</i> configuration factory.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Ubuntu_12_04_Apache_FrontaccountingConfigFactory implements ServiceConfigFactory {
    ...
    /**
     * <i>FrontAccounting</i> service name.
     */
    public static final String WEB_NAME = "frontaccounting_2_3";
    ...
    /**
     * <i>FrontAccounting</i> service information.
     */
    ...
    private static final Module[] MODULES = new Module[] { new Ubuntu_12_04_Apache_Module() };

    private Injector injector;

    public Ubuntu_12_04_Apache_FrontaccountingConfigFactory() {
    }

    @Override
    public ServiceConfig getScript() throws ServiceException {
        return injector.getInstance(Ubuntu_12_04_Apache_FrontaccountingConfig.class);
    }
