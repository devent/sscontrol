...
/**
 * <i>Ubuntu 12.04 Piwik</i> configuration factory for <i>Nginx</i> proxy.
 * 
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Ubuntu_12_04_NginxProxyPiwikConfigFactory implements ServiceConfigFactory {
     ...
     */
    public static final String WEB_NAME = "proxy.piwik";
    ...
    private static final Module[] MODULES = new Module[] { new ProxyModule() };

    private Injector injector;

    public Ubuntu_12_04_NginxProxyPiwikConfigFactory() {
    }
