...
import static com.anrisoftware.sscontrol.core.groovy.bindingaddressstatements.BindingAddressesStatementsLogger._.binding_address_invalid;
import static com.anrisoftware.sscontrol.core.groovy.bindingaddressstatements.BindingAddressesStatementsLogger._.binding_address_null;
...
/**
 * Logging for {@link BindingAddressesStatements}.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
class BindingAddressesStatementsLogger extends AbstractLogger {
    ...
    /**
     * Sets the context of the logger to {@link BindingAddressesStatements}
     * .
     */
    public BindingAddressesStatementsLogger() {
        super(BindingAddressesStatements.class);
    }
