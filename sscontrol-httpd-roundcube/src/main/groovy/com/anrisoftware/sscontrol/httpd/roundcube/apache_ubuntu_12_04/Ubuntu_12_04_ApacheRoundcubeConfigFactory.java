...
/**
 * <i>Roundcube</i> configuration factory for <i>Apache Ubuntu 12.04</i>.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Ubuntu_12_04_ApacheRoundcubeConfigFactory implements ServiceConfigFactory {
     ...
     */
    public static final String WEB_NAME = "roundcube";
    ...
    public Ubuntu_12_04_ApacheRoundcubeConfigFactory() {
    }

    @Override
    public ServiceConfig getScript() throws ServiceException {
        return injector.getInstance(UbuntuApacheRoundcubeConfig.class);
    }
