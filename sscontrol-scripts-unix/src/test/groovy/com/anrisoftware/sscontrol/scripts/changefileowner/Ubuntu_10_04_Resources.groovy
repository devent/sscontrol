...
enum Ubuntu_10_04_Resources {
    ...
    chownCommand("/bin/chown", Ubuntu_10_04_Resources.class.getResource("echo_command.txt")),
    ...
    chownOutExpected("/bin/chown.out", Ubuntu_10_04_Resources.class.getResource("chown_out_expected.txt")),
    chownRecursiveOutExpected("/bin/chown.out", Ubuntu_10_04_Resources.class.getResource("chown_recursive_out_expected.txt")),
