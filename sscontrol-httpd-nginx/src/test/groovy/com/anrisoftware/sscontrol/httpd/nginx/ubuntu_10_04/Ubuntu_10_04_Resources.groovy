 ...
 */
package com.anrisoftware.sscontrol.httpd.nginx.ubuntu_10_04
...
enum Ubuntu_10_04_Resources {
    ...
    nginxConfFile("/etc/nginx/nginx.conf", Ubuntu_10_04_Resources.class.getResource("nginx_conf.txt")),
    sourcesListFile("/etc/apt/sources.list", Ubuntu_10_04_Resources.class.getResource("sources_list.txt")),
    nginxSigningKeyFile("/tmp/web-nginx_signing.key", Ubuntu_10_04_Resources.class.getResource("nginx_signing_key.txt")),
