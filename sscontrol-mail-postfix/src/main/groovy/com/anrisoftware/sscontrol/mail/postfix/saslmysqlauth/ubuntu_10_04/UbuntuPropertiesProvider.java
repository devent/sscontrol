...
/**
 * SASL/authentication Ubuntu 10.04 properties provider.
 * 
 * <ul>
 * <li>{@code "/postfix_saslauth_ubuntu_10_04.properties"}
 * </ul>
 * 
...
public class UbuntuPropertiesProvider extends
	...
	private static final URL RESOURCE = UbuntuPropertiesProvider.class
            .getResource("/postfix_saslmysqlauth_ubuntu_10_04.properties");
