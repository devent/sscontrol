...
/**
 * <i>phpMyAdmin</i> web service factory.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(WebServiceFactoryFactory.class)
public class PhpmyadminFactoryFactory implements WebServiceFactoryFactory {
    ...
    private static final Module[] MODULES = new Module[] { new PhpmyadminModule() };

    private Injector injector;

    public PhpmyadminFactoryFactory() {
    }

    @Override
    public WebServiceFactory getFactory() throws ServiceException {
        return injector.getInstance(PhpmyadminServiceFactory.class);
    }
