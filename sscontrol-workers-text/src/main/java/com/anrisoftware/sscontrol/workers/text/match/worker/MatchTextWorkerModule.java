...
public class MatchTextWorkerModule extends AbstractModule {
	...
	protected void configure() {
		install(new FactoryModuleBuilder().implement(MatchTextWorker.class,
				MatchTextWorker.class).build(MatchTextWorkerFactory.class));
		bind(WorkerFactory.class).to(MatchTextWorkerFactory.class);
	}
}
