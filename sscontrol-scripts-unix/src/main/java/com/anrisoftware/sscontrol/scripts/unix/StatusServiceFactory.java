...
/**
 * Factory to create the status service script.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
public interface StatusServiceFactory {

    /**
     * Create the status service script.
     *
     * @param args
     ...
     *
     *            <li>{@code command} the status service {@link String} command;
     *
     *            <li>{@code service} the {@link String} name of service to
     *            test;
     *
     *            <li>{@code flags} optionally, set the extra {@link String}
     *            flags for the status command that is attached after the
     *            service name.
     *
     ...
     *
     * @return the {@link StatusService}.
     */
    StatusService create(Map<String, Object> args, Object parent,
            Threads threads);
}
