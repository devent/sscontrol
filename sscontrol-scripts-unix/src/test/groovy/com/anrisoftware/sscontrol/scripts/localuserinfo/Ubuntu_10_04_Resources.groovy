...
enum Ubuntu_10_04_Resources {
    ...
    idCommand("/usr/bin/id", Ubuntu_10_04_Resources.class.getResource("id_command.txt")),
    idNoUserCommand("/usr/bin/id", Ubuntu_10_04_Resources.class.getResource("id_nouser_command.txt")),

    static void copyUbuntu_10_04_Files(File parent) {
        idCommand.createCommand parent
    }
