...
enum DomainsResources {
    ...
    // used ports proxy
    usedportsproxyNetstatCommand("/bin/netstat", DomainsResources.class.getResource("usedportsproxy_netstat.txt")),
    ...
    // users existing
    usersExistingNginxConfExpected("/etc/nginx/nginx.conf", DomainsResources.class.getResource("domains_nginxconf_expected.txt")),
    usersExistingDefaultsConfExpected("/etc/nginx/conf.d/000-robobee_defaults.conf", DomainsResources.class.getResource("domains_defaultsconf_expected.txt")),
