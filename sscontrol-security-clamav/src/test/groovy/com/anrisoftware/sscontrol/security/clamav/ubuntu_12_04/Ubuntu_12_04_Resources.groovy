...
enum Ubuntu_12_04_Resources {
    ...
    securityService("Security.groovy", Ubuntu_12_04_Resources.class.getResource("Security.groovy")),
    securityMinimalService("Security.groovy", Ubuntu_12_04_Resources.class.getResource("SecurityMinimal.groovy")),
    // commands
    clamavDaemonRestartCommand("/etc/init.d/clamav-daemon", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
    clamavDaemonStatusCommand("/etc/init.d/clamav-daemon", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
    freshclamRestartCommand("/etc/init.d/clamav-freshclam", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
    freshclamCommand("/usr/bin/freshclam", Ubuntu_12_04_Resources.class.getResource("echo_command.txt")),
    // files
    clamavConfFile("/etc/clamav/clamd.conf", Ubuntu_12_04_Resources.class.getResource("clamd_conf.txt")),
    freshclamConfFile("/etc/clamav/freshclam.conf", Ubuntu_12_04_Resources.class.getResource("freshclam_conf.txt")),
    // expected
    clamavAptitudeOutExpected("/usr/bin/aptitude.out", Ubuntu_12_04_Resources.class.getResource("clamav_aptitude_out_excepted.txt")),
    clamavConfFileExpected("/etc/clamav/clamd.conf", Ubuntu_12_04_Resources.class.getResource("clamav_clamav_conf_expected.txt")),
    // Minimal expected
    minimalAptitudeOutExpected("/usr/bin/aptitude.out", Ubuntu_12_04_Resources.class.getResource("clamav_aptitude_out_excepted.txt")),
    minimalClamavConfFileExpected("/etc/clamav/clamd.conf", Ubuntu_12_04_Resources.class.getResource("minimal_clamav_conf_expected.txt")),
