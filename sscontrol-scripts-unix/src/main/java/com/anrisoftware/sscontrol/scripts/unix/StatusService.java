...
/**
 * Asks the status of a service.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
public class StatusService extends AbstractProcessExec {
    ...
    @Inject
    private StatusServiceLogger log;
    ...
    /**
     * @see StatusServiceFactory#create(Map, Object, Threads)
     */
    @Inject
    StatusService(@Assisted Object parent, @Assisted Threads threads,
    ...
    protected CommandLine createLine(ScriptCommandLineFactory commandLineFactory) {
        ...
        String name = format("%s%s", "status", capitalize(system));
    ...
    public ProcessTask call() throws Exception {
        ...
        log.statusDone(parent, task, args);
        return task;
    }

    private TemplateResource getTemplate() {
        return commandTemplates.get().getResource("status");
    }
