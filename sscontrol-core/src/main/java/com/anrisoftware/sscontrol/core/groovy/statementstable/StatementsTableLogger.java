...
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.allowed_name;
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.invalid_statement;
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.key_not_allowed;
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.name_value_error;
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.statement_key;
import static com.anrisoftware.sscontrol.core.groovy.statementstable.StatementsTableLogger._.statement_table_added;
...
class StatementsTableLogger extends AbstractLogger {
    ...
    void checkNameValueAllowed(StatementsTable statements,
        ...
        if (allowedKeys.contains(StatementsTable.NAME_KEY)) {
            return;
        }
