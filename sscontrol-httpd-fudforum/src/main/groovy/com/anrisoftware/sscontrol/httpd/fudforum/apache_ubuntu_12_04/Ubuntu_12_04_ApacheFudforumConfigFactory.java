...
/**
 * <i>FUDForum</i> configuration factory for <i>Apache Ubuntu 12.04</i>.
 *
 * @author Erwin Mueller, erwin.mueller@deventm.org
 * @since 1.0
 */
@ProviderFor(ServiceConfigFactory.class)
public class Ubuntu_12_04_ApacheFudforumConfigFactory implements ServiceConfigFactory {
     ...
     */
    public static final String WEB_NAME = "fudforum";
    ...
    public Ubuntu_12_04_ApacheFudforumConfigFactory() {
    }

    @Override
    public ServiceConfig getScript() throws ServiceException {
        return injector.getInstance(UbuntuApacheFudforumConfig.class);
    }
