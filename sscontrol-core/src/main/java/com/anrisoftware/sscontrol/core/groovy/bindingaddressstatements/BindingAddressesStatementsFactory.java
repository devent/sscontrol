 ...
 * @since 1.0
 */
public interface BindingAddressesStatementsFactory {
     ...
     *
     * @return the {@link BindingAddressesStatements}.
     */
    BindingAddressesStatements create(Object service, String name);
}
