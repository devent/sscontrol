...
/**
 * MaraDNS/Ubuntu 14.04 service script properties provider. Provides the script
 * properties from the {@code "/maradns_ubuntu_14_04.properties"} file.
 *
...
class UbuntuPropertiesProvider extends AbstractContextPropertiesProvider {
    ...
    private static final URL RESOURCE = UbuntuPropertiesProvider.class
            .getResource("/maradns_ubuntu_14_04.properties");
